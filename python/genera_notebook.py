...
REPO = "fabiofurini/laboratorio-ricerca-operativa"
SITO = "https://fabiofurini.github.io/laboratorio-ricerca-operativa"
RAW_STILE = f"https://raw.githubusercontent.com/{REPO}/main/python/stile.py"
...
CODICE_PREPARAZIONE = f'''# Ambiente: il solver e lo stile grafico del laboratorio.
...
if importlib.util.find_spec("stile") is None:
    ...
    if locale is not None:
        ...
        urllib.request.urlretrieve("{RAW_STILE}", "stile.py")   # Colab
'''
...
INDICE = """# I notebook del laboratorio
...
def pagina_indice() -> str:
    ...
    righe = []
    for percorso in sorted(DIR_SCRIPT.glob("lab*.py")):
        nome = percorso.stem
